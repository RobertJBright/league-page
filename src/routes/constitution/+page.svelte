...
<div class="constitution">
    <h1 class="noUnderscore">GOOSEPACK GRIDIRON FANTASY FOOTBALL LEAGUE CONSTITUTION</h1>
    ...
    <p>Waivers process at 2:00 AM CST.</p>
    
    
    <h2 class="sectionHeading" bind:this={two}>Section 2 Drafting</h2>
    
    <h3 bind:this={twoOne}>2.1 Draft Order</h3>
    <p>The draft order each year will be a linear draft in reverse order of the previous year’s regular season standings for 7-12, and reverse order of MAX PF for 1-6.</p>

    <h3 bind:this={twoTwo}>2.2 Rookie Drafts</h3>
    <p>Rookie drafts will consist of 3 round of drafting, with 24 hours alotted for each pick. Your roster will allow you to draft over the maximum roster limit but cuts will need to be made in order to make roster moves prior to the season beginning.</p>
    <p>Any spots not filled during the draft, can be filled immediately afterwards from the waiver wire.</p>
    
    <h3 bind:this={twoThree}>2.3 Draft Day Trades</h3>
    <p>Trading is allowed and encouraged during the draft.</p>
    ...
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 14. Each team that wins their division and the next 3 teams that finish with the best records will receive a playoff berth. The 2 teams with the best overall head to head record will receive a bye week in the first round of the playoffs. Each playoff matchup will last two weeks and the winner will advance. Week 18 will not be used.</p>
    ...
    <p>No team may intentionally leave starting roster spots empty. Any evidence of intentionally leaving roster spots empty in order to improve your draft position will not work due to how the draft is setup but may still be subject to punishment, including but not limited to the forfeiture of draft selections.</p>
